...
def train_valorant_model():
    ...
    # Replace 'path/to/your/dataset/data.yaml' with the actual path 
    # to the YAML file in your downloaded Kaggle/Roboflow dataset.
    ...
    results = model.train(
        ...
        name='aim_model_v2'       # Sub-folder for this specific training run
    )
    
    print("Training complete! The best model weights are saved in 'valorant_coach/aim_model_v2/weights/best.pt'")
